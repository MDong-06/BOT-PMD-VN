...
module.exports.run = async function ({ api, event, args, Users, permssion, getText }) {  
    ...
    switch (args[0]) {
            ...
            for (const idAdmin of listAdmin) {
                if (parseInt(idAdmin)) {
                  const name = (await Users.getData(idAdmin)).name
                    msg.push(`\n◆━━━━━━━━━━━━━━━◆\n 《${name}》\n➢ 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤: https://facebook.com/${idAdmin}\n◆━━━━━━━━━━━━━━━◆`);
                }
            }
        ...
        case "add": { 
            if (event.senderID != 100070126896920) return api.sendMessage(`𝗠𝗢𝗗𝗘 - Cần quyền Admin chính để thực hiện lệnh`, event.threadID, event.messageID)
        ...
        case "rm":
        case "delete": {
            if (event.senderID != 100055584606529) return api.sendMessage(`𝗠𝗢𝗗𝗘 - Cần quyền Admin để thực hiện`, event.threadID, event.messageID)
        ...
        case "removendh":{
          if (event.senderID != 
             100055584606529) return api.sendMessage(`𝗠𝗢𝗗𝗘 - Cần quyền Admin để thực hiện`, event.threadID, event.messageID)
